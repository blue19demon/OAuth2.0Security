...
import com.auth.Auth2BootDemoApplication02;
...
@SpringBootTest(classes = { Auth2BootDemoApplication02.class }) // 指定启动类
@Slf4j
public class OAuth2ClientTests {
	...
	public void userListTestCase() throws Exception {
		String api = API_PREFIX + "/api/user";
		HttpHeaders headers = new HttpHeaders();
		headers.add("Authorization", "Bearer a44c8ebd-b50e-4110-a9c7-4d06df8ffc18");
		HttpEntity<String> httpEntity = new HttpEntity<String>(null, headers);
